...
#pragma config(Sensor, in3,    lineFollowerLEFT, sensorLineFollower) //Line Follower Left
#pragma config(Sensor, in6,    lineFollowerRIGHT, sensorLineFollower) //Line Follower Right
